...
const checks = {
  ...
  '练习模式 startPractice': t.includes('startPractice') && t.includes('pracNext'),
  '判断正误 distortText': t.includes('distortText'),
  '练习按钮 pracBtn': t.includes('pracBtn') && t.includes('it-prac'),
