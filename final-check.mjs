...
const checks = {
  ...
  '练习模式 startPractice': html.includes('startPractice') && html.includes('pracNext'),
  '判断正误 distortText': html.includes('distortText'),
  '练习按钮 pracBtn': html.includes('pracBtn') && html.includes('it-prac'),
